...
ALTER TABLE testing.valhalla_route_shape
    ADD CONSTRAINT valhalla_route_shape_pkey PRIMARY KEY (trip_id, search_radius, gps_accuracy, segment_index);
...
ALTER TABLE testing.valhalla_route_fail
    ADD CONSTRAINT valhalla_route_fail_pkey PRIMARY KEY (trip_id, search_radius, gps_accuracy, segment_index);
