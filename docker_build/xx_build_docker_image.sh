...
docker buildx build --platform linux/amd64 --tag minus34/valhalla:amd64 .
docker buildx build --platform linux/arm64 --tag minus34/valhalla:arm64 .
docker manifest create minus34/valhalla:latest minus34/valhalla:amd64 minus34/valhalla:arm64
docker manifest push minus34/valhalla:latest
